...
public class DBIKPSPublicSoap
{
    ...
    public DBIKPSPublicSoap(){}

    public DBIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DBIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DBIExtendedSoapSerializationEnvelope envelope= new DBIExtendedSoapSerializationEnvelope(DBIExtendedSoapSerializationEnvelope.VER11);
