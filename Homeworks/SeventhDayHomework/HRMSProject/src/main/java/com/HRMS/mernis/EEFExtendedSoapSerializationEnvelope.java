...
public class EEFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EEFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EEFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EEFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EEFDateTimeConverter dateTimeConverter = new EEFStandardDateTimeConverter();

    public EEFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EEFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EEFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EEFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EEFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EEFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
