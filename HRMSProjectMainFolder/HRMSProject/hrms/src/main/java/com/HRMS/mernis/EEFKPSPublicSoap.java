...
public class EEFKPSPublicSoap
{
    ...
    public EEFKPSPublicSoap(){}

    public EEFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EEFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EEFExtendedSoapSerializationEnvelope envelope= new EEFExtendedSoapSerializationEnvelope(EEFExtendedSoapSerializationEnvelope.VER11);
